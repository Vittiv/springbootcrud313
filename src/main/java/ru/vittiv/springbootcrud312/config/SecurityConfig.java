...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    private  UserDetailsService userDetailsService; // сервис, с помощью которого получаем пользователя
    @Autowired
    private  LoginSuccessHandler loginSuccessHandler; // класс, в котором описана логика перенаправления пользователей после логина
    @Autowired
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .antMatchers("/login", "/registration", "/create","/hello").anonymous()
                // защищенные URL
